...
Este repositório hospeda vários aplicativos, incluindo o **Finn**, que lida com
dados financeiros pessoais. Levamos relatos de segurança a sério e agradecemos
quem reporta falhas de forma responsável.
...
- Qual aplicativo, endpoint ou tela é afetado.
...
Estão no escopo os aplicativos deste repositório, com prioridade para os que
...
- Vulnerabilidades em serviços de terceiros (Supabase, Cloudflare, Meta/WhatsApp,
  Telegram, Mercado Pago, Mercado Livre) — reporte diretamente a eles.
